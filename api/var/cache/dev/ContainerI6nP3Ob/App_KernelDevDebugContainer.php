...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\BodyRepository' => ['privates', 'App\\Repository\\BodyRepository', 'getBodyRepositoryService', true],
            'App\\Repository\\BusRepository' => ['privates', 'App\\Repository\\BusRepository', 'getBusRepositoryService', true],
            'App\\Repository\\ChildRepository' => ['privates', 'App\\Repository\\ChildRepository', 'getChildRepositoryService', true],
            'App\\Repository\\DriverRepository' => ['privates', 'App\\Repository\\DriverRepository', 'getDriverRepositoryService', true],
            'App\\Repository\\GuardianRepository' => ['privates', 'App\\Repository\\GuardianRepository', 'getGuardianRepositoryService', true],
            'App\\Repository\\RouteRepository' => ['privates', 'App\\Repository\\RouteRepository', 'getRouteRepositoryService', true],
            'App\\Repository\\SeatRepository' => ['privates', 'App\\Repository\\SeatRepository', 'getSeatRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\WheelRepository' => ['privates', 'App\\Repository\\WheelRepository', 'getWheelRepositoryService', true],
            'App\\Repository\\WindowRepository' => ['privates', 'App\\Repository\\WindowRepository', 'getWindowRepositoryService', true],
        ], [
            'App\\Repository\\BodyRepository' => '?',
            'App\\Repository\\BusRepository' => '?',
            'App\\Repository\\ChildRepository' => '?',
            'App\\Repository\\DriverRepository' => '?',
            'App\\Repository\\GuardianRepository' => '?',
            'App\\Repository\\RouteRepository' => '?',
            'App\\Repository\\SeatRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\WheelRepository' => '?',
            'App\\Repository\\WindowRepository' => '?',
        ])));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventListener\\PasswordEncoderListener'] ?? $this->load('getPasswordEncoderListenerService'));
        }, 1 => 'encodePassword'], 33);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RISphp+xXN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n1Na8XbEL4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p-QcfZRmbD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q31rOcFBS6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VFivy93I9U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m9DIBleDfU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ARfHxtoNRL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
